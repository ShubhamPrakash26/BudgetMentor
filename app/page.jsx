        ...
        <section className="py-20 bg-blue-600">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
                Join thousands of users who are already managing their finances smarter with Budget Mentor
              </p>
              <Link href="/dashboard">
                <Button
                  size="lg"
                  className="px-8 bg-white text-blue-600 hover:bg-blue-50 animate-bounce"
                >
                  Start Free Trial
                </Button>
              </Link>
